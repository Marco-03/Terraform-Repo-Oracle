...
module "image_metadata" {
  ...
  additional_metadata = merge(
    ...
    {
      linkurious_demo_enabled = tostring(var.linkurious_demo_enabled)
    },
    var.linkurious_demo_enabled ? {
...
module "adb" {
  ...
  datapump_enabled             = var.datapump_enabled
  datapump_dump_uris           = var.datapump_dump_uris
  datapump_encryption_password = var.datapump_encryption_password
  datapump_credential_name     = var.datapump_credential_name
  datapump_credential_username = var.datapump_credential_username
  datapump_credential_password = var.datapump_credential_password
  datapump_source_schema       = var.datapump_source_schema
  datapump_target_schema       = var.datapump_target_schema
}
