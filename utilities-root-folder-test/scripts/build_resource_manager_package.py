...
DEFAULT_OUTPUT = (
    SOURCE_ROOT / "dist" / "utilities-livestack-terraform.zip"
)
...
PAYLOAD_EXCLUDES = (
    ...
    "coverage",
    "coverage/**",
    # Compose is retained for the donor's local demo but is not part of the
    # managed one-container runtime payload.
    "compose.yml",
    "scripts/pull_" + "oll" + "ama.sh",
    "backend/lib/oll" + "amaAssistant.js",
...
OUTER_EXCLUDES = (
    ...
    "application",
    "application/**",
    # Build-time planning/evidence directories are not Resource Manager input.
    "docs",
    "docs/**",
    "input",
    "input/**",
